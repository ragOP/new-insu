...
var campaignID = "679046e22b9f9a66de064dc5";
...
var initialSrc = "https://sub.newsavingsforamericans.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("sub.newsavingsforamericans.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://sub.newsavingsforamericans.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://sub.newsavingsforamericans.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
